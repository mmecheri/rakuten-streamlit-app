...
# @st.cache
    def run(self):
        ...
        title = st.sidebar.radio(self.radio_label, titles, index=default_radio, key="unique_radio_key")
        ...
        st.sidebar.image(Image.open("./doc/ecom.png"))


@st.cache_resource()
def participants():    
    # text = """ Promotion Juin 2021/Formation continue
    text = """Data Scientist program – June 2021 cohort"""
